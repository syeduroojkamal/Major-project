...
.btn-primary{
  ...
  <body style="padding-top:50px; background: -webkit-linear-gradient(left, white,maroon); background-size: cover;" >
  
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 40%;  padding-bottom: 20px; font-family: '', sans-serif;"> Welcome &nbsp<?php echo $username ?> 
   </h3>
    <div class="row">
    ...
    <div class="tab-content" id="nav-tabContent" style="width: 950px;">
      ...
      <div class="tab-pane fade  show active" id="list-dash" role="tabpanel" aria-labelledby="list-dash-list">
        <div class="container-fluid container ">
              <div class="row">
               <div class="col-sm-4" style="left: 5% background:maroon;" >
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-terminal fa-stack-1x fa-inverse"></i> </span>
                      <a href="#list-home" onclick="clickDiv('#list-home-list')" style="color:black; text-decoration:none;" >  <h4 class="StepTitle" style="margin-top: 5%;"> Book My Appointment</h4></a>
                      <script>
