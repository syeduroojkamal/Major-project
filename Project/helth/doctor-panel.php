...
.StepTitle{
  ...
  <body style="padding-top:50px; background: -webkit-linear-gradient(left, white, white); background-size: cover;">
   <div class="container-fluid" style="margin-top:50px;">
   <strong> <h3 style = "margin-left: 40%; padding-bottom: 20px; sans-serif;"> Welcome &nbsp<?php echo $_SESSION['dname'] ?>  </h3></strong>
    <div class="row">
  ...
  <div class="col-md-8" style="margin-top: 3%;">
               ...
               <div class="col-sm-4" style="left: 10%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x"></i> <i class="fa fa-list fa-stack-1x fa-inverse"></i> </span>
                      <a href="#list-app" onclick="clickDiv('#list-app-list')">
                          
                     <h4 class="StepTitle" style="margin-top: 5%;"> View Appointments</h4></a>
                      <script>
   ...
   <h4 class="StepTitle" style="margin-top: 5%;"> Prescriptions</h4></a>
