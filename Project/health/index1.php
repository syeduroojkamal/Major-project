...
<body style="background: -webkit-linear-gradient(left, black, pink); background-size: cover;">
    ...
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4> HEALTHCARE CENTER</h4></a>
    ...
    animation: mover 1s infinite alternate;">
          <img src="img/patient-icon-9264.png" alt="" style="width: 20%;padding-left: 40px;margin-top: 150px;margin-left: 45px;margin-bottom:15px">
      </div>

      <div style="color: white;">
            <h4 style="font-family: 'IBM Plex Sans', sans-serif; right:3%;">Welcome to Patient Portal, <br>Your Medical Home on the Web
With Patient Portal, you can connect with your doctor through a convenient, safe and secure environment. </h4>
          </div>

         </div>

         <div class="col-md-4" style="margin-top: 5%;left: ">
          <div class="" style="font-family: 'IBM Plex Sans', sans-serif;">
            <div class="card-body">
              <center>
              ...
              <form class="form-group" method="POST" action="func.php">
                ...
                <div class="row">
                 <div class="col-md-4"  style="padding-left: 160px;margin-top: 10%">
                    <center><input type="submit" id="inputbtn" name="patsub" value="Login" class="btn btn-primary" style="background:maroon;"></center></div>           
