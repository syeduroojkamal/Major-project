...
.StepTitle{
  ...
  <body style="padding-top:50px;">
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 40%; padding-bottom: 20px;color: white;font-family: 'IBM Plex Sans', sans-serif;"> WELCOME RECEPTIONIST </h3>
    <div class="row">
               ...
               <div class="col-sm-4">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <a href="#list-doc" onclick="clickDiv('#list-doc-list')"> <h4 class="StepTitle" style="margin-top: 5%;">Doctor List</h4></a>
                      <script>
                ...
                <div class="col-sm-4" style="left: -3%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x "></i> <i class="fa fa-users fa-stack-1x fa-inverse"></i> </span>
                      <a href="#app-hist" onclick="clickDiv('#list-pat-list')">  <h4 class="StepTitle" style="margin-top: 5%;">Patient List</h4></a>
                ...
                <div class="col-sm-4">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      ...
                      <a href="#app-hist" onclick="clickDiv('#list-app-list')">  <h4 class="StepTitle" style="margin-top: 5%;" >Appointment Details</h4></a>
                ...
                <div class="col-sm-4" style="left: 13%;margin-top: 5%;">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x"></i> <i class="fa fa-list-ul fa-stack-1x fa-inverse"></i> </span>
                      <a href="#list-pres" onclick="clickDiv('#list-pres-list')"> <h4 class="StepTitle" style="margin-top: 5%;">Prescription List</h4></a>
                ...
                <div class="col-sm-4" style="left: 18%;margin-top: 5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x "></i> <i class="fa fa-plus fa-stack-1x fa-inverse"></i> </span>
